...
public class Room extends GamePiece {
	public static final Map<InteractionResult, Integer> WEIGHTED_INTERACTION_PROBABILITY = Map.of(InteractionResult.KILL, 5, InteractionResult.HIT, 20, InteractionResult.GET_POINT, 20, InteractionResult.NONE, 55);
